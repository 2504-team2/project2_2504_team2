...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/merchantManage.css">
    <script type="text/javascript">
        ...
        function merchantManage_update(id) {
            location.href = "<%= request.getContextPath() %>/admin/merchant/merchantUpdate.jsp?id=" + id;
        }
    </script>
</head>
<body>
